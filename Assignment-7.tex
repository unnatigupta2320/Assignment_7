...
\end{align}
The coordinates of foci of ellipse,$\vec{F}$ are 
 \begin{align}
  \vec{F} &= \pm \brak{\sqrt{\frac{(\vec{u}^T\vec{V}^{-1}\vec{u}-f)(\lambda_2-\lambda_1)}{\lambda_1\lambda_2}}} \label{eqZ}
\end{align}
...
\end{align}
\item Using \eqref{eqZ}, the focus ellipse is given as:
\begin{align}
 \vec{F} &= \pm \brak{\sqrt{\frac{(\vec{u}^T\vec{V}^{-1}\vec{u}-f)(\lambda_2-\lambda_1)}{\lambda_1\lambda_2}}}
 \end{align}
 or
 \begin{align}

...
\end{lemma}
\begin{lemma}
The coordinates of foci of ellipse $\vec{F}$ with x-axis as major axis are:
 \begin{align}
  \vec{F} &= \myvec{ \pm \brak{\sqrt{\frac{(\vec{u}^T\vec{V}^{-1}\vec{u}-f)(\lambda_2-\lambda_1)}{\lambda_1\lambda_2}}}\\0} \label{eqZ}
\end{align}
...
\begin{align}
     \vec{y}^{\top}\myvec{\frac{1}{41}& 0 \\ 0 & \frac{1}{16}}\vec{y}=1
\end{align}
